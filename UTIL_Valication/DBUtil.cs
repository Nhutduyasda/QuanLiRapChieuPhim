...
namespace UTIL_Valication
{
    public class DBUTIL
    {
        private static string connString = "Data Source=DESKTOP-PKFG1AR\\MAY007;Database=QuanLiRapChieuPhim;Integrated Security=True;Encrypt=True;TrustServerCertificate=True;";
